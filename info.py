...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", """<b>ɴᴀᴍᴇ: <code>{file_name}</code> \n\n This File Will Be Deleted In 5min So Forward It To Your Save message then download there [⚡Forward this file to your save message](https://t.me/Movies_x_store)</b>""")
