...
from info import REQ_CHANNEL, AUTH_CHANNEL, JOIN_REQS_DB, ADMINS,CHNL_LNK ,GRP_LNK
...
join request bhejo  𝐑𝐞𝐪𝐮𝐞𝐬𝐭 𝐭𝐨 𝐣𝐨𝐢𝐧 pe click krke fir uske bad  𝐓𝐫𝐲 𝐀𝐠𝐚𝐢𝐧 pe click kro mil jayega file 

agr Koi problem ho rha to message owner"""
        ...
        buttons = [
            ...
            [   InlineKeyboardButton("Owner", url="https://t.me/don_owner"),
