...
from database.connections_mdb import active_connection, all_connections, delete_connection, if_active, make_active, \
    make_inactive
from info import ADMINS, AUTH_CHANNEL, CUSTOM_FILE_CAPTION, REQ_CHANNEL, GRP_LNK, CHNL_LNK
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('💝 Join Channel 💗', url=f'http://t.me/Movies_x_store')
            ],[
            InlineKeyboardButton('♻️ Bot Update Channel ♻️', url=f't.me/sid_botz')
            ],[
